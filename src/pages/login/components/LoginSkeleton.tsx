...
export function LoginSkeleton() {
  return (
    <div className="relative min-h-screen w-screen overflow-hidden bg-[#F4F8FC] antialiased md:grid md:grid-cols-12 select-none">
      ...
      <div className="md:col-span-6 lg:col-span-5 flex flex-col justify-between min-h-screen p-8 lg:p-12">
        ...
        <div className="flex items-center justify-between md:hidden py-2 border-b border-slate-200/40">
          <div className="flex items-center gap-2">
            <Skeleton className="h-8 w-8 rounded-lg bg-slate-200" />
            <Skeleton className="h-4.5 w-20 bg-slate-200" />
          </div>
        ...
        <div className="my-auto w-full max-w-[400px] mx-auto space-y-6">
          <div className="rounded-3xl border border-slate-200/50 bg-white p-7 lg:p-9 shadow-sm text-center space-y-6">
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="space-y-2 mt-2 w-full flex flex-col items-center">
                ...
                <Skeleton className="h-3.5 w-[85%] bg-slate-150" />
                <Skeleton className="h-3.5 w-[70%] bg-slate-150" />
              </div>
            </div>
          ...
          <div className="rounded-2xl border border-slate-200/30 bg-white/40 p-4 flex gap-3">
            <Skeleton className="h-5 w-5 rounded-md bg-slate-200 shrink-0" />
